 ...
 *
 */
public class BillingDetailDataSet implements Serializable {
	
	private static final long serialVersionUID = -4869040538124733163L;// 序列化
	...
	private ListResult members;// 会员信息
	...
	public ListResult getMembers() {
		return members;
	}

	public void setMembers(ListResult members) {
		this.members = members;
	}

	@Override
	public String toString() {
		return "BillingDetailDataSet [payInfoId=" + payInfoId + ", serialNum="
				+ serialNum + ", countPerson=" + countPerson + ", payPrice="
				+ payPrice + ", managePrice=" + managePrice + ", createTime="
				+ createTime + ", members=" + members + "]";
	}
