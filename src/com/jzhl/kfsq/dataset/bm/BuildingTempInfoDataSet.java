...
public class BuildingTempInfoDataSet implements Serializable {
	private static final long serialVersionUID = 5678828760008542167L;
	...
	private List<UnitMapTemp> unitMapTempList;
	private List<BuildingFeatureTemp> buildingFeatureTempList;
	...
	public List<UnitMapTemp> getUnitMapTempList() {
		return unitMapTempList;
	}
	public void setUnitMapTempList(List<UnitMapTemp> unitMapTempList) {
		this.unitMapTempList = unitMapTempList;
	}
	public List<BuildingFeatureTemp> getBuildingFeatureTempList() {
		return buildingFeatureTempList;
	}
	public void setBuildingFeatureTempList(
			List<BuildingFeatureTemp> buildingFeatureTempList) {
		this.buildingFeatureTempList = buildingFeatureTempList;
	}
	...
	public String toString() {
		return "BuildingTempInfoDataSet [buildingId=" + buildingId
				+ ", buildingName=" + buildingName + ", developer=" + developer
				+ ", phone=" + phone + ", averagePrice=" + averagePrice
				+ ", sectionMin=" + sectionMin + ", sectionMax=" + sectionMax
				+ ", address=" + address + ", position=" + position
				+ ", areaName=" + areaName + ", surrounding=" + surrounding
				+ ", buildingInfo=" + buildingInfo + ", banner=" + banner
				+ ", sourceBanner=" + sourceBanner + ", isSynchronous="
				+ isSynchronous + ", createTime=" + createTime
				+ ", updateTime=" + updateTime + ", lastSynchronousTime="
				+ lastSynchronousTime + ", isValid=" + isValid + ", cityId="
				+ cityId + ", unitMapTempList=" + unitMapTempList
				+ ", buildingFeatureTempList=" + buildingFeatureTempList
