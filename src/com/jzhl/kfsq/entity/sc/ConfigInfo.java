...
public class ConfigInfo implements Serializable {
	...
	private java.lang.Integer order; // 排序
	...
	public String toString() {
		return "ConfigInfo [configId=" + configId + ", configType=" + configType + ", configTypeName=" + configTypeName + ", configKey="
				+ configKey + ", configValue=" + configValue + ", creatorUserId=" + creatorUserId + ", createTime=" + createTime
				+ ", updateUserId=" + updateUserId + ", updateTime=" + updateTime + ", order=" + order + "]";
	}
