...
public class PushInfo implements Serializable {
	...
	private java.lang.String targetGroup; // 目标人群（0：全部，1：会员，2：售楼员，3：销售经理），可多选，用','间隔
	...
	private java.lang.String name; // 推送人姓名
	private java.lang.String areaName; // 推送城市
	...
	public String toString() {
		return "PushInfo [pushId=" + pushId + ", title=" + title + ", content=" + content + ", targetGroup=" + targetGroup + ", cityId="
				+ cityId + ", pushType=" + pushType + ", isOffLine=" + isOffLine + ", isSuccess=" + isSuccess + ", customTime="
				+ customTime + ", createTime=" + createTime + ", creatorUserId=" + creatorUserId + ", name=" + name + ", areaName="
				+ areaName + ", memberId=" + memberId + "]";
	}
