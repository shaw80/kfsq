...
public class VersionUpdate implements Serializable {
	...
	private static final long serialVersionUID = -5627134542291942947L;
	...
	public String toString() {
		return "VersionUpdate [versionId=" + versionId + ", versionNum=" + versionNum + ", updateCode=" + updateCode + ", filePath="
