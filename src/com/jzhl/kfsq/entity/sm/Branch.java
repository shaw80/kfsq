...
public class Branch implements Serializable {
	...
	private java.lang.Short cityStatus; // 0：未开通、1：开通
	...
	public java.lang.Short getCityStatus() {
		return cityStatus;
	}

	public void setCityStatus(java.lang.Short cityStatus) {
	...
	public String toString() {
		return "Branch [branchId=" + branchId + ", comanyName=" + comanyName + ", comanyAddress=" + comanyAddress + ", phone=" + phone
				...
				+ ", areaName=" + areaName + ", IDCardImg=" + IDCardImg + ", cityStatus=" + cityStatus + ", userId=" + userId + "]";
	}
