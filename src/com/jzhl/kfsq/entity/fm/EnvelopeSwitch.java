 ...
 *
 */
public class EnvelopeSwitch implements Serializable {
	...
	public String toString() {
		return "EnvelopeSwitch [switchId=" + switchId + ", branchId="
				+ branchId + ", switchType=" + switchType + ", switchStatus="
				+ switchStatus + ", updateUserId=" + updateUserId
