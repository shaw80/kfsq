 ...
 *
 */
public class PriceInfoDto extends PageListCondition implements Serializable {
	...
	public String toString() {
		return "PriceInfoDto [priceId=" + priceId + ", minPrice=" + minPrice + ", maxPrice=" + maxPrice + ", createTime=" + createTime
