 ...
 *
 */
public class CommunityQualityDto implements Serializable {
	...
	public String toString() {
		return "CommunityQualityDto [communityQualityId=" + communityQualityId
				+ ", buildingId=" + buildingId + ", developerId=" + developerId
				+ ", propertyId=" + propertyId + ", locationId=" + locationId
				+ ", greenRates=" + greenRates + ", carNumber=" + carNumber
				+ ", ratioOfSpaces=" + ratioOfSpaces + ", IsSeparation="
				+ IsSeparation + ", spaceOfCarImg=" + spaceOfCarImg
				+ ", greenImg=" + greenImg + ", parkFacilitiesImg="
				+ parkFacilitiesImg + ", createTime=" + createTime
