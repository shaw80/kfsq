...
public abstract class PlatformNotification implements PushModel {
	...
	protected static final Logger LOG = Logger.getLogger(PlatformNotification.class);
	...
	public PlatformNotification(String alert, Map<String, String> extras, Map<String, Number> numberExtras,
